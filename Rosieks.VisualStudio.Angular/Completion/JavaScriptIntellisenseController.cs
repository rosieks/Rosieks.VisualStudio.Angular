namespace Rosieks.VisualStudio.Angular.Completion
{
    ...
    {
        [Import]
        Intel.ICompletionBroker CompletionBroker = null;
    ...
    internal sealed class JsCommandFilter : IOleCommandTarget
    {
        ...
        public JsCommandFilter(IWpfTextView textView, Intel.ICompletionBroker CompletionBroker, IStandardClassificationService standardClassifications)
        {
            TextView = textView;
